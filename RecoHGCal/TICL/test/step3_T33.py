...
# with command line options: step3 -s RAW2DIGI,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation --eventcontent FEVTDEBUGHLT --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-RECO --geometry ExtendedRun4D110 --era Phase2C17I13M9 --filein file:step2.root --fileout file:step3.root -n -1 --procModifiers ticl_v5 --customise RecoHGCal/TICL/customiseTICLFromReco.customiseTICLForDumper --nThreads 8 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/grid_mnt/data_cms_upgrade/biriukov/data/singleElectrons_D110/step3/15_1_0_pre1/step3/step3_597.root'),
...
# Automatic addition of the customisation function from RecoHGCal.TICL.customiseTICLFromReco
from RecoHGCal.TICL.customiseTICLFromReco import customiseTICLForDumper 

#call to customisation function customiseTICLForDumper imported from RecoHGCal.TICL.customiseTICLFromReco
